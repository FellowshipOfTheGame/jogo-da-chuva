...
namespace Puzzle
{
    public class Tile
    {
        ...
        public static int TileSize = 400;
        ...
        {
            new Vector2(0, 0),
            new Vector2(35*4, 15*4),
            new Vector2(47*4, 13*4),
            new Vector2(45*4, 5*4),
            new Vector2(48*4, 0*4),
            new Vector2(25*4, -5*4),
            new Vector2(15*4, -18*4),
            new Vector2(36*4, -20*4),
            new Vector2(64*4, -20*4),
            new Vector2(85*4, -18*4),
            new Vector2(75*4, -5*4),
            new Vector2(52*4, 0*4),
            new Vector2(55*4, 5*4),
            new Vector2(53*4, 13*4),
            new Vector2(65*4, 15*4),
            new Vector2(100*4, 0)
        };

        // The template Bezier curve.
        public static List<Vector2> BezCurve = BezierCurve.PointList2(ControlPoints, 0.0001f);
